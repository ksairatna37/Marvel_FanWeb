...
<body>
	...
	<header id="myHeader">
      ...
      <ul>
		...
		<div class="content">
			<div class="textBox">
				<h2><span>The Incredible Hulk</span>   </h2>
				<p>Dr Bruce Banner subjects himself to high levels of gamma radiation which triggers his transformation into a huge green creature, the Hulk, whenever he experiences negative emotions such as anger.</p>
				<a href="https://www.youtube.com/watch?v=xbqNb2PFKKA">Watch trailer now</a>
			</div>
		</div>
	</section>
	<!--Page Section End-->
